    ...
    <aside className={clsx(
      ...
      <div className={clsx(
        ...
        <div className="flex items-center gap-4 overflow-hidden group/brand cursor-pointer">
          {/* [THORNE] Logo Mark: Custom SVG Injection */}
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-panel-soft to-panel border border-white/10 flex items-center justify-center shrink-0 shadow-lg group-hover/brand:shadow-primary/20 group-hover/brand:border-primary/30 transition-all duration-500 p-2">
            <img src="/icons/app-icon.svg" alt="Aaranya Logo" className="w-full h-full object-contain" />
          </div>
